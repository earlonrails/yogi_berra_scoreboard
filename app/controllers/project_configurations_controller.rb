  ...
  def create
    ...
    respond_to do |format|
      if @project_configuration.save
        format.html { redirect_to @project_configuration, notice: 'Project configuration was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @project_configuration.update_attributes(params[:project_configuration])
        format.html { redirect_to @project_configuration, notice: 'Project configuration was successfully updated.' }
